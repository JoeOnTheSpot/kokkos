...
FUNCTION(COMPILER_SPECIFIC_OPTIONS_HELPER)
  ...
  IF (PARSE_LINK_OPTIONS)
    # SH 
    string(REPLACE /clang:-fopenmp=libomp "" COMPILER_SPECIFIC_FLAGS_TMP_MOD ${COMPILER_SPECIFIC_FLAGS_TMP})
    # /SH
    GLOBAL_APPEND(KOKKOS_LINK_OPTIONS ${COMPILER_SPECIFIC_FLAGS_TMP_MOD})
  ENDIF()
